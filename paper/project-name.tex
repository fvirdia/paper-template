...
\usepackage[bookmarksdepth=2,colorlinks=true,citecolor=NavyBlue,linkcolor=ForestGreen]{hyperref}
...
%\newcommand{\fernando}[2][inline]{\todo[#1,color=PineGreen!40]{\textbf{fernando:} #2}\xspace}

% using marginpars
\newcommand{\fernando}[2][inline]{\marginpar{\colorbox{PineGreen!40}{\textbf{fernando:}} #2}\xspace}

% using textcolor
%\newcommand{\fernando}[2][inline]{\colorbox{PineGreen!40}{\textbf{fernando:}} \textcolor{PineGreen}{#2}\xspace}

% disable present comments
%\renewcommand{\fernando}[2][inline]{}
...
\section{Introduction}\label{sec:introduction}
 ...
 \fernando{An example note for some example text.}
